...
# render_diagnostico_idi_mipg(), invocada desde el router principal app.py.
# Contiene EXACTAMENTE el mismo flujo y cálculos de antes (v6.1), sin cambios.
...
def render_diagnostico_idi_mipg() -> None:
    """Ejecuta el flujo completo del Diagnóstico IDI-MIPG (v6.1), sin cambios."""
    try:
