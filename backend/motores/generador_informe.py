...
def _filas_inversion_brechas(diag, top_n=5):
    ...
    for d in dims_ordenadas:
        ...
        etiqueta = f"{d.nombre} ({valor_protagonista_dimension(d):.2f})"
...
def generar_reporte_docx(nombre_entidad, diag, analisis_ia_texto, resultado_isvpt=None, resultado_360=None, idi_oficial=None, cruce_recomendaciones=None, total_recomendaciones_entidad=None, tipo_regimen_especial=None, recomendaciones_completas=None):
    ...
    agregar_capitulo_plan_mejoramiento_formal_docx(doc, diag, cruce_recomendaciones, nombre_entidad, numero_seccion=7)
